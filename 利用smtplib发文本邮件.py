...
sender = 'zhangxiaofeng9971@126.com'  # 设置发件邮箱，一定要自己注册的邮箱
pwd = 'z@@@@@@@@1'  # 设置发件邮箱的密码，等会登陆会用到
receiver = '1157956981@qq.com'  # 设置邮件接收人，可以是扣扣邮箱
body = '<h1>19年春节早餐</h1><p>新年</p>'  # 设置邮件正文，这里是支持HTML的

msg = MIMEText(body, 'html')  # 设置正文为符合邮件格式的HTML内容
msg['subject'] = '新年快乐'  # 设置邮件标题
